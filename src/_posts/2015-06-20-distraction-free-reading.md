...
{% include figure.html src="assets/pimg/without-readability.png" alt="صفحه در حالت عادی" caption="صفحه در حالت عادی" %}
...
{% include figure.html src="assets/pimg/with-readability.png" alt="صفحه در حالت مطالعه" caption="صفحه در حالت مطالعه" %}
